    ...
    <section id="greeting" className="section">
      <div className="container">
          ...
          <div className="greeting-layout">
            ...
            <div className="greeting-content">
              <p className="greeting-lead">
                더원산업은 산업 장비용 케이스와 함체를 설계부터 제작까지 통합
                대응하는 제조 파트너입니다.
              </p>
              ...
              <ul className="greeting-points">
                ...
                <li>
                  대응 분야: 주차 관제, 통신 장비, 카메라 장비 및 현장 프로젝트
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="greeting-message" aria-label="대표 인사말">
          <h2>대표 인사말</h2>
          <p>
            더원산업은 각종 장비 보호 케이스 제작 업체로, 무인차량 번호 인식
            카메라 케이스, 로비폰, 무인과속 카메라 케이스, 프로젝트 빔 케이스,
            ITS 장비 함체 등을 제작하고 있습니다.
          </p>
          <p>
            케이스는 구성 장비가 최적의 상태로 유지되고 보존될 수 있도록
            맞춤형으로 설계하며, 장비의 수명과 동작 효율을 안정적으로 유지할 수
            있도록 제작하고 있습니다.
          </p>
          <p>
            앞으로도 끊임없는 개선과 성실한 품질 관리로 고객 만족을 위해 최선을
            다하겠습니다.
          </p>
